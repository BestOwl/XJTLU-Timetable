...
namespace Timetable.UWP
{
    ...
    public class ShellItemCustomRenderer : UwpGrid, IAppearanceObserver, IFlyoutBehaviorObserver
    {
        ShellSectionCustomRenderer SectionRenderer { get; }
        TextBlock _Title;
        ...
        internal ShellCustomRenderer ShellContext { get; set; }

        public ShellItemCustomRenderer(ShellCustomRenderer shellContext)
        {
        ...
        internal void SetShellContext(ShellCustomRenderer context)
        {
        ...
        void UpdateAppearance(ShellAppearance appearance)
        {
            ...
            var titleColor = ShellCustomRenderer.DefaultTitleColor;
            if (appearance != null)
            {
        ...
        void SwitchSection(ShellNavigationSource source, ShellSection section, Xamarin.Forms.Page page, bool animate = true)
        {
            SectionRenderer.NavigateToShellSection(source, section, animate);
        }

        Xamarin.Forms.Page DisplayedPage { get; set; }

        void UpdateDisplayedPage(Xamarin.Forms.Page page)
        {
